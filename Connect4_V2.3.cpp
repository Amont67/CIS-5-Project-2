/*
    ...
    Date: June 10th, 2026
    Purpose: Connect 4 project 2 version 2.3 
*/
...
void swap2 ( string &, string & );               //swap strings 
void prntHst ( vector<string>, string header = "-- Game History --" );                 //print game history 
...
int main(int argv,char **argc) {
    ...
    cout << "Each round counts as 1 point - The first to 3 points wins the whole game!" << endl;
...
//Bubble sort - sorting scores high to low
...
//Print game history 
void prntHst ( vector<string> hist, string header ) {
    cout << "\n-- Game History --" << endl;
